...
class Model(object):
  ...
  def build_inference_for_training(self):
    ...
    with tf.variable_scope('depth_prediction'):
      ...
      for i in range(self.seq_length):
        ...
        multiscale_disps_i, disp_bottlenecks[i] = net.disp_net(
    ...
    if self.handle_motion:
      ...
      with tf.variable_scope('egomotion_prediction'):
        ...
        self.egomotion = net.egomotion_net(
      ...
      with tf.variable_scope('objectmotion_prediction'):
        ...
        for s in range(NUM_SCALES):
          ...
          for i in range(self.batch_size):
            ...
            all_transforms = net.objectmotion_net(
  ...
  def build_depth_test_graph(self):
    ...
    with tf.variable_scope('depth_prediction'):
      ...
      est_disp, _ = net.disp_net(architecture=self.architecture,
                                 image=input_image,
  ...
  def build_egomotion_test_graph(self):
    ...
    if self.joint_encoder:
      ...
      with tf.variable_scope('depth_prediction', reuse=True):
        ...
        encoder_selected = net.encoder(self.architecture)
        for i in range(self.seq_length):
    ...
    with tf.variable_scope('egomotion_prediction'):
      est_egomotion = net.egomotion_net(
  ...
  def build_objectmotion_test_graph(self):
    ...
    with tf.variable_scope('objectmotion_prediction'):
      est_objectmotion = net.objectmotion_net(
  ...
  def get_multiscale_depths_i(self)
